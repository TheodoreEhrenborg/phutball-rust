...
// Board, Side, Piece, Position, Direction and all evaluators are in phutball_core
...
impl Player for PloddingPlayer {
    fn make_move(&self, board: &Board) -> String {
        PloddingEngine::make_move(board)
    }
}
...
// Delegates to phutball_core::Eval6Engine
// ============================================================================
...
impl Player for TimedPlayer6 {
    fn make_move(&self, board: &Board) -> String {
        let engine = Eval6Engine { budget_ms: self.ms, eval_fn: self.eval_fn };
